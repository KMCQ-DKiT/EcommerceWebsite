...
export default class CheckoutBasketTableRow extends Component
{
    componentDidMount()
    {
        ...
        return (
            <tr>
                ...
                <td>
                    ...
                    {localStorage.accessLevel >= ACCESS_LEVEL_NORMAL_USER ? <Link className="red-button" to={"/DeleteFromCart/" + this.props.car._id}>Delete</Link> : null}
